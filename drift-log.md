- **2026-04-22 | dcb2a8e** — merge: bring staging sync commits into main (Phase 3 design sync)
  ...
  - ⚠️ CONFLICT: src/components/MarketingFooter.jsx, src/components/MarketingHeader.jsx, src/components/RoomForm/RoomStudioPreview.jsx (+28)
...
- **2026-04-11 | 442a4aa** — File changes
  ...
  - ⚠️ CONFLICT: src/components/ui/FloatingPanel.jsx

- **2026-04-11 | d4df16b** — File changes
  - Files changed: 2
  - NEW: 1, MODIFIED: 1, CONFLICT: 0
...
- **2026-04-11 | ad879b0** — File changes
  - Files changed: 7
  - NEW: 3, MODIFIED: 4, CONFLICT: 0

- **2026-04-11 | ae210dd** — File changes
  - Files changed: 5
  - NEW: 1, MODIFIED: 4, CONFLICT: 0

- **2026-04-11 | 1c572b9** — File changes
  - Files changed: 8
  - NEW: 2, MODIFIED: 6, CONFLICT: 0
...
- **2026-04-11 | 8f1d175** — File changes
  - Files changed: 1
  - NEW: 0, MODIFIED: 0, CONFLICT: 1
  - ⚠️ CONFLICT: src/components/dashboard/MonthCalendar.jsx
...
**Summary:** ✨ NEW (2): base44/entities/iPadCommand.jsonc, base44/functions/iPadVersionControl/entry.ts | 📝 MODIFIED (4)
...
**Summary:** 🚨 CONFLICT (1): src/components/ui/FloatingPanel.jsx | 📝 MODIFIED (4)
...
**Summary:** ✨ NEW (1): src/components/dashboard/FloatingEventPanel.jsx | 📝 MODIFIED (1)
...
**Summary:** 🚨 CONFLICT (1): src/components/ui/FloatingPanel.jsx | 📝 MODIFIED (3)
...
**Summary:** ✨ NEW (2): src/components/ipad/DemoScreen.jsx, src/components/ipad/IdleScreen.jsx | 📝 MODIFIED (4)
...
**📝 MODIFIED:** src/components/Sidebar.jsx, src/components/dashboard/DashboardMetricCard.jsx, src/components/dashboard/FloatingDayPanel.jsx, src/components/dashboard/SessionTimelineCard.jsx, src/hooks/useTheme.js (+2)
...
**Summary:** 🚨 CONFLICT (1): src/pages/Landing.jsx
...
**📝 MODIFIED:** base44/entities/RoomLightingLayout.jsonc, base44/entities/iPadCommand.jsonc, src/components/ipad/InSessionScreen.jsx, src/components/ipad/LightingCanvas.jsx, src/components/ipad/LightingPanel.jsx (+1)
...
**Summary:** ✨ NEW (7): src/contracts/schema/enums.json, src/contracts/schema/relationships.json, src/contracts/schema/tables.json

**Files Changed:** 7

**✨ NEW:** src/contracts/schema/enums.json, src/contracts/schema/relationships.json, src/contracts/schema/tables.json, src/database/MIGRATION_REPORT.md, src/database/mappings/base44-map.ts (+2)
...
**Summary:** ✨ NEW (2): src/database/data-migration-plan.md, src/database/migration-order.json | 📝 MODIFIED (3)
...
**Summary:** ✨ NEW (1): src/components/ProtectedRoute.jsx | 📝 MODIFIED (2)
...
**Files:** 0× NEW, 0× MODIFIED, 10× CONFLICT
**Total files changed:** 10 **CONFLICT:** src/components/ui/EmptyState.jsx, src/components/ui/FilterPills.jsx, src/components/ui/PortalDrawer.jsx, src/components/ui/PortalTable.jsx, src/components/ui/SearchInput.jsx (+5 more)


## 2026-04-22 05:04 UTC | 18e25d25
**Message:** sync: booking components — refined versions from Claude Code
**Files:** 0× NEW, 0× MODIFIED, 2× CONFLICT
**Total files changed:** 2 **CONFLICT:** src/components/booking/BookingDateTimeStep.jsx, src/components/booking/ClientSelectStep.jsx


## 2026-04-22 05:04 UTC | 923b30e2
**Message:** sync: marketing components — refined versions from Claude Code
**Files:** 0× NEW, 0× MODIFIED, 3× CONFLICT
**Total files changed:** 3 **CONFLICT:** src/components/MarketingFooter.jsx, src/components/MarketingHeader.jsx, src/components/marketing/RoomOperatingHoursDisplay.jsx


## 2026-04-22 05:04 UTC | 3564003b
**Message:** sync: RoomForm components — refined versions from Claude Code
**Files:** 0× NEW, 0× MODIFIED, 2× CONFLICT
**Total files changed:** 2 **CONFLICT:** src/components/RoomForm/RoomStudioPreview.jsx, src/components/RoomForm/WebsitePreviewCard.jsx


## 2026-04-22 05:04 UTC | 38853339
**Message:** sync: dashboard and iPad components — refined versions from Claude Code
**Files:** 0× NEW, 0× MODIFIED, 3× CONFLICT
**Total files changed:** 3 **CONFLICT:** src/components/dashboard/MonthCalendar.jsx, src/components/ipad/FiveMinWarning.jsx, src/components/ipad/ThankYouScreen.jsx


## 2026-04-22 05:04 UTC | 22cdea70
**Message:** sync: BookingFlow.jsx — refined version from Claude Code
**Files:** 0× NEW, 0× MODIFIED, 1× CONFLICT
**Total files changed:** 1 **CONFLICT:** src/pages/BookingFlow.jsx


## 2026-04-22 05:04 UTC | f19cdf03
**Message:** sync: website marketing pages — refined versions from Claude Code
**Files:** 0× NEW, 0× MODIFIED, 4× CONFLICT
**Total files changed:** 4 **CONFLICT:** src/pages/Landing.jsx, src/pages/RoomProfile.jsx, src/pages/Services.jsx, src/pages/Studios.jsx


## 2026-04-22 05:04 UTC | aa4661f4
**Message:** sync: website booking and auth pages — refined versions from Claude Code
**Files:** 0× NEW, 0× MODIFIED, 6× CONFLICT
**Total files changed:** 6 **CONFLICT:** src/pages/DynamicCreditsPage.jsx, src/pages/DynamicMembershipsPage.jsx, src/pages/GuestBuyCredits.jsx, src/pages/MembershipSignup.jsx, src/pages/Register.jsx (+1 more)
